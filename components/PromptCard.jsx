  ...
  return (
    <div className='prompt_card'>
      ...
      <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer' onClick={handleProfileClick}>
        <Image src={post.creator.image} alt='profile_pic' width={40} height={40} className='rounded-full object-contain'  />
      ...
      {session?.user.id == post.creator._id && pathName=='/profile' && (
        <div className='flex flex-center gap-5 mt-5 border-t border-gray-200 pt-3'>
